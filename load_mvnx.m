...
% LOAD_MVNX Imports an mvnx file to MATLAB.
%
...
% Modified by Steven Hlucny for the matlab_mvnx_library
% University of Wyoming, 2019-2020

%% check filename
if isempty(strfind(filename,'mvnx'))
    filename = strjoin([filename '.mvnx'], '');
end
